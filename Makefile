init: docker-down docker-build composer-install migrate import-data

checks: composer-validate cs-check phpstan-check

import-data:
	docker compose exec php-cli bin/console import:characters-and-episodes
	docker compose exec php-cli bin/console import:reviews
